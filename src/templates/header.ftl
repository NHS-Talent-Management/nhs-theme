<header class="nhsuk-header" role="banner">
	<div class="nhsuk-width-container nhsuk-header__container">
		<div class="nhsuk-header__logo">
			<a class="nhsuk-header__link ${logo_css_class} header-logo" href="${site_default_public_url}" title="<@liferay.language_format arguments="${company_name}" key="go-to-x" />"  aria-label="${company_name}">
